  ...
  const testimonials = [
    {
      ...
      role: "Maker",
      avatar: "https://pbs.twimg.com/profile_images/1784563357300740096/2DyzEa9d_400x400.jpg",
    },
    {
      name: "Larry",
      rating: 5,
      ...
      role: "Founder",
      avatar: "https://pbs.twimg.com/profile_images/1804234365817212928/n077GepN_400x400.jpg",
    },
    {
      name: "Gabriel",
    ...
    },
    {
      ...
      role: "Entrepreneur",
      avatar: "https://pbs.twimg.com/profile_images/1761628238323802112/pXIc00nu_400x400.jpg",
    },
    {
      name: "Matt Merrick",
      ...
      role: "Founder",
      avatar: "https://pbs.twimg.com/profile_images/1865828164947099648/v0SAw6WI_400x400.jpg",
    },
    {
      name: "Tom Friday",
      rating: 5,
      ...
      role: "Maker",
      avatar: "https://pbs.twimg.com/profile_images/1854135042152247311/9u2s6TX__400x400.jpg",
    },
    {
      name: "Sarah Johnson",
      rating: 4,
      ...
      role: "Indie Hacker",
      avatar: "https://pbs.twimg.com/profile_images/1878117566222041088/_AtC29wQ_400x400.jpg",
    },
    {
      name: "Alex Chen",
      ...
      avatar: "https://pbs.twimg.com/profile_images/1830918748439506958/E4cv0RQf_400x400.jpg",
    },
    {
      name: "Emmil Mittov",
      rating: 5,
      ...
      role: "SaaS Founder",
      avatar: "https://pbs.twimg.com/profile_images/1884948973007319040/JYnP4PK2_400x400.jpg",
    },
  ]
    ...
    <div className="min-h-screen bg-[#0F0F0F] text-white py-16 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg">They made their first $ online, and some even quit their 9-5!</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {testimonials.map((testimonial, index) => (
            <Card key={index} className="bg-zinc-900 border-[1.4px] border-zinc-800 p-6 flex flex-col">
              <div className="flex-grow">
                ...
                <p className="text-gray-300 mb-6" dangerouslySetInnerHTML={{ __html: testimonial.text }}></p>
              </div>
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-zinc-700 mt-auto">
                ...
                <div>
                  <h3 className="font-semibold text-base text-zinc-300">{testimonial.name}</h3>
