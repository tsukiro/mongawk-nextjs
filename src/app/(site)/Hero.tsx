      ...
      <div className="max-w-7xl w-full mx-auto py-16 flex flex-col lg:flex-row justify-between items-center">
        <div className="w-full lg:w-1/2 mb-12 lg:mb-0 text-center lg:text-left">
          ...
          <p className="text-base text-[#CFCFCF] mb-8 max-w-2xl mx-auto lg:mx-0">
            Organiza tu vida como si fuera un videojuego. Mongawk convierte tus tareas en misiones, tus hábitos en logros y tu día a día en una aventura épica. 
          </p>
          ...
          >
            ...
            ¡Registrate! y comienza tu aventura
          </Link>
