      ...
      <div className="bg-[#212121] mb-8 text-gray-300 p-8">
        <div className="max-w-2xl mx-auto space-y-8">
          ...
          <div className="space-y-6">
            <p className="text-base">
              We created ShipFree for 3 reasons:
            </p>
            ...
            <ol className="space-y-4 list-decimal list-inside">
              ...
              <li className="text-base">
                <span className="font-semibold text-white">Avoid headaches</span>—no
                more struggling with email deliverability, payments, or auth.
              </li>
              <li className="text-base">
                <span className="font-semibold text-white">Get profitable faster</span>—the
                faster you ship, the quicker you validate and earn.
              </li>
            </ol>
